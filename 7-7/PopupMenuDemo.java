...
public class PopupMenuDemo extends java.awt.Frame implements ActionListener, ItemListener {
  ...
  public PopupMenuDemo() {
	...
	//建立第二個突顯式選單 pop menu 在label範圍
	popupmenu1 = new PopupMenu("popup menu");
	menuitemforlabel= new MenuItem("TTest");
	menuitemforlabel.addActionListener(this);//監聽
	popupmenu1.add(menuitemforlabel);
	add(popupmenu1);
  ...
  public void showPopmenu1(MouseEvent e) {
    // 當按下滑鼠按鍵時
    if (e.getButton() == MouseEvent.BUTTON3) 
      // 顯示突顯式選單
